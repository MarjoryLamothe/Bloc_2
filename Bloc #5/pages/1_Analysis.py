...
fig1 = px.bar(delay, y='delay_category', title='Number of rentals depending on possible threshold', color='delay_category', 
             category_orders={'index':['No delay', 'Less than 15 minutes', '15 to 30 minutes', '30 minutes to 1 hour', '1 to 2 hours', '2 to 3 hours', '3 to 4 hours', '4 to 5 hours', '5 to 6 hours', '6 to 12 hours', '12 hours to a day', '1 to 5 days', '5 to 10 days', '10 to 15 days', 'More than 15 days']})
